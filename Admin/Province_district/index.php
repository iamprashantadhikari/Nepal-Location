...
<head>
    ...
    <title>Nepal Loaction | Province District</title>
...
if($_SESSION['role']=="admin"){
    ...
    $sql = "SELECT * FROM province_district WHERE status='active'";
}
...
?>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Province District</li>
    </ol>
    </nav>
        ...
        <tbody> 
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="delete_province_district.php?id=<?php echo $row['id'];?>"><button class="delete"><i class="fa-solid fa-trash"></i>delete</button></a>
                    <?php } ?>
                </td>
            </tr>
