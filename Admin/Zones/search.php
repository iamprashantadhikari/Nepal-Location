...
<body>
    ...
    $search = $_POST['search'];
    $sql = "SELECT * FROM zone WHERE zone LIKE '%".$search."%'";
...
<table id="example" class="table table-striped table-bordered" style="width:100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="update_zone_status_inactive.php?id=<?php echo $row['id'] ?>" class="active"><?php if($row['status']=="active") echo "<button>Active</button>" ?></a>
