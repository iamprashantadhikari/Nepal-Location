...
if($updated_file_name){
    ...
    $sqlUpdate = "UPDATE media SET title='$title',img='$updated_file_name',description='$description',updatedate='$updated_date',updatedBy='$updatedBy' WHERE id='$id'";
    ...
    $sqlUpdate = "UPDATE media SET title='$title',description='$description',updatedate='$updated_date',updatedBy='$updatedBy' WHERE id='$id'";
    $resultUpdate = mysqli_query($conn,$sqlUpdate);
    if($resultUpdate){
        header("location: index.php");
    }
