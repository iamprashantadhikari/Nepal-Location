...
<body>
  <div class="container mt-3">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item h4 active" aria-current="page">Municipility</li>
    </ol>
    </nav>
  </div>
    <div class="container">
              ...
              <?php if(mysqli_num_rows($resultMuni)>0){ ?>
                <?php while($rowMuni=mysqli_fetch_array($resultMuni)){ ?>
                  <tr>
                    ...
                    <td><a href="../Municipility/index.php?id=<?php echo $rowMuni['id'] ?>"><?php echo $rowMuni['municipility'] ?> </a></td>
