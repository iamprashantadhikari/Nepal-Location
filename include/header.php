...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/nepalLocation/style/style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.2.0/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</head>
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary navbar-dark bg-dark position-fixed w-100" style="z-index:999;">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="http://localhost/nepalLocation/index.php">Home</a>
              </li>
              <li class="nav-item">
    ...
    <script src="http://localhost/nepalLocation/admin/bootstrap-5.3.0-alpha2-dist/js/bootstrap.min.js"></script>
